...
class ProductBulkLoader extends CsvBulkLoader
{
    ...
    public static function set_product_class_name($s)
    {
        self::$product_class_name = $s;
    }
    public static function get_product_class_name()
    {
        return self::$product_class_name;
    }

    protected static $product_group_class_name = "ProductGroup";
    public static function set_product_group_class_name($s)
    {
        self::$product_group_class_name = $s;
    }
    public static function get_product_group_class_name()
    {
        return self::$product_group_class_name;
    }

    protected static $parent_page_id = null;
    public static function set_parent_page_id($i)
    {
        self::$parent_page_id = intval($i);
    }
    ...
    public static function set_create_new_product_groups($b = true)
    {
        self::$create_new_product_groups = $b;
    }
    public static function get_create_new_product_groups()
    {
        return self::$create_new_product_groups;
    }
